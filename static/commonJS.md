...
- [返回一个键盘](#返回一个键盘)
- [移动端1px边框](#移动端1px边框)
- [js监听目标元素内部变化](#js监听目标元素内部变化)
- [get请求向现有URL的末尾添加查询字符串参数](#get请求向现有URL的末尾添加查询字符串参数)
- [创建XHR对象](#创建XHR对象)
- [使用XHR创建一个get请求](#使用XHR创建一个get请求)
- [回到页面顶部（带动画）](#回到页面顶部（带动画）)
- [js判断移动端是Android还是IOS](#js判断移动端是Android还是IOS)
- [JavaScript调试](#JavaScript调试)
- [时间戳的转化](#时间戳的转化)
- [解决ios中软键盘不回弹的问题](#解决ios中软键盘不回弹的问题)
- [解决安卓软键盘遮挡住input](#解决安卓软键盘遮挡住input)
- [h5下载文件 适合各种文件类型](#h5下载文件 适合各种文件类型)
- [h5导出pdf文件](#h5导出pdf文件)
- [h5添加水印](#h5添加水印)
